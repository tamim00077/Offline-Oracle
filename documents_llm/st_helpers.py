...
from streamlit.runtime.uploaded_file_manager import UploadedFile  # <-- ADD THIS LINE
...
def save_uploaded_file(
    uploaded_file: UploadedFile, output_dir: Path = Path("/tmp") # <-- QUOTES REMOVED
) -> Path:
...
def run_query(
    uploaded_file: UploadedFile, # <-- QUOTES REMOVED
    summarize: bool,
    user_query: str,
    start_page: int,
    end_page: int,
